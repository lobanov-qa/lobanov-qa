...
- Работа с современным стеком: HTTPX, Pydantic (строгая валидация данных), Allure (детальная отчетность).
...
Полный список пройденных курсов и сертификатов по тестированию доступен на моём профиле Stepik:  
→ [https://stepik.org/users/419833413/profile](https://stepik.org/users/419833413/profile)

*Ключевые направления: теория тестирования, автоматизация API/UI, Python.*
